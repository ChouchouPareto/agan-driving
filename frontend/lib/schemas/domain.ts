...
export const agentDispatchSchema = z.object({ conversation_id: z.string(), intent: z.string(), skill_id: z.string(), action: z.enum(["ANSWER", "NAVIGATE", "SUGGEST_NAVIGATION", "RESPOND"]), question_id: z.string().nullable(), destination: z.string().nullable(), assistant_message: z.string().nullable(), prompt_version: z.string() });
